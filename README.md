...
## Чего ещё не хватает до сдачи

- **Эталонный пул** в `benchmarks/reference/` и отчёт качества (глазами / SSIM / expert)
- **Замеры** времени / RAM / CPU на 1–15 Мпк во всех целевых браузерах (особенно Safari)
- **Быстрый apply** (WASM или WebGL) — JS-тайлы могут не уложиться в avg 5 с на 15 Мпк
...
- **Разнообразный датасет + стабильный чекпоинт** под сдачу (микс photo / faces / anime)
